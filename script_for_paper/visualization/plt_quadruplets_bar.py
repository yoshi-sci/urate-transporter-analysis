...
def plt_quadruplets_bar(database, option, reverse):
    ...
    plot_quadruplets_stack_bar(ax, color, database, fig, l_ITS, l_ITS_DP, l_ITS_DP_ITR, l_ITS_DP_ITR_DN, label, option,
                               patterns, r_ITS, r_ITS_DP, r_ITS_DP_ITR, r_ITS_DP_ITR_DN, zorder)


def plot_quadruplets_stack_bar(ax, color, database, fig, l_ITS, l_ITS_DP, l_ITS_DP_ITR, l_ITS_DP_ITR_DN, label, option,
                               patterns, r_ITS, r_ITS_DP, r_ITS_DP_ITR, r_ITS_DP_ITR_DN, zorder):
